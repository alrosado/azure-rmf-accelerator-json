...
title: Add-ARAChangeManagement
---

# Add-ARAChangeManagement
...
```
Add-ARAChangeManagement -Process <string> -ApprovalAuthorityRoleKey <string>
...
```
Add-ARAChangeManagement -ChangeManagement <ChangeManagement>
```
...
Adds a new change management configuration to the connected ARA file.

## EXAMPLES

### Example 1

Add-ARAChangeManagement -Process "MyProcess" -ApprovalAuthorityRoleKey "MyRole" -SourceRepository "MyRepo" -DeploymentMethod "MyMethod" -ConfigurationBaseline "MyBaseline" -Audit $auditObject

Creates a new ChangeManagement object in the currently connected ARA file.
...
The ChangeManagement object to add.
