...
```
New-ARAFile [-System] <string> [-Version] <string> [-Customer] <string> [-ImpactLevel <string>]
 [-Classification <string>] [-Schema <string>]
```
...
The data classification level (e.g., "Unclassified", "Confidential").
...
The customer name associated with the ARA file.
...
The security impact level (e.g., "Low", "Moderate", "High").
...
The system name for the new ARA file.
...
The version number for the new ARA file.
