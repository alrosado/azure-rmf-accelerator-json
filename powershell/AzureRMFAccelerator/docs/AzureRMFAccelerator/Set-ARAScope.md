...
```
Set-ARAScope [-InScope <string[]>] [-Description <string>] [-OutOfScope <string[]>]
 [-Constraints <string[]>] [-Assumptions <string[]>] [-Dependencies <string[]>] [-Audit <Audit>]
```

### Object

```
Set-ARAScope -Scope <Scope>
```
