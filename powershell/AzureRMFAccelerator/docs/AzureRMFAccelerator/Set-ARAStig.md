...
```
Set-ARAStig [-TargetKey] <string> [-TargetType] <string> [[-Name] <string>]
 [[-ApplierRoleKey] <string>] [-Description <string>]
```

### Object

```
Set-ARAStig -Stig <Stig>
```
